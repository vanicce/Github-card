...
<template>
  <div id="conteudo"
    class="flex flex-col justify-center items-center p-3 rounded-3xl border border-zinc-300 w-4/5 m-2 md:w-1/4 lg:max-w-sm transition-all" :class="shareStore.showModal ? 'blur-lg' : ''">
  ...
  <div class="flex justify-between w-4/5 max-w-sm md:w-1/4">
    <Button />
